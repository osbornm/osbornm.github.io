...
excerpt: With the latest release of WebMatrix and ASP.NET WebPages I am proud to announce that we have been working to clean up the HTML, CSS, JavaScript, and general file and folder structures of the templates that we ship with the product.
date: 2010-10-06
---
...
<ul>
    <li>Templates need to pass the accessibility tests at: http://wave.webaim.org/</li>
...
<ul>
    <li>Templates need to pass validation at: http://validator.w3.org/ Both HTML &amp; CSS</li>
</ul>
