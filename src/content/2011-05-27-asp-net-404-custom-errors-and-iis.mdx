...
excerpt: Better 404 pages in ASP.NET
date: 2011-05-27
---
...
<div className="wlWriterEditableSmartContent" id="scid:9ce6104f-a9aa-4a17-a79f-3a39532ebf7c:fe25d6ec-ceef-4967-9092-df597ae1e310" css="margin: 0px; display: inline; float: none; padding: 0px;">
...
<ol css="background: #ffffff; margin: 0 0 0 2em; padding: 0 0 0 5px; white-space: nowrap;">
    <li><span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">system.web</span><span css="color: #0000ff;">&gt;</span></li>
    <li css="background: #f3f3f3;">    <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">compilation</span><span css="color: #ff0000;">debug</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">true</span>"<span css="color: #ff0000;">targetFramework</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">4.0</span>"<span css="color: #0000ff;"> /&gt;</span></li>
    <li>    <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">customErrors</span><span css="color: #ff0000;">mode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">On</span>"<span css="color: #ff0000;">defaultRedirect</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">/error</span>"<span css="color: #0000ff;">&gt;</span></li>
    <li css="background: #f3f3f3;">        <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">error</span><span css="color: #ff0000;">statusCode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">404</span>"<span css="color: #ff0000;">redirect</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">~/404</span>"<span css="color: #0000ff;"> /&gt;</span></li>
    <li>    <span css="color: #0000ff;">&lt;/</span><span css="color: #a31515;">customErrors</span><span css="color: #0000ff;">&gt;</span></li>
    <li css="background: #f3f3f3;"><span css="color: #0000ff;">&lt;/</span><span css="color: #a31515;">system.web</span><span css="color: #0000ff;">&gt;</span></li>
</ol>
</div>
</div>
</div>
...
<div className="wlWriterEditableSmartContent" id="scid:9ce6104f-a9aa-4a17-a79f-3a39532ebf7c:5750d989-a9b5-4806-956e-d202058a42eb" css="margin: 0px; display: inline; float: none; padding: 0px;">
<div css="border: #000080 1px solid; color: #000; font-family: 'Courier New', Courier, Monospace; font-size: 10pt;">
<div css="background: #ddd; max-height: 300px; overflow: auto;">
<ol css="background: #ffffff; margin: 0 0 0 2em; padding: 0 0 0 5px; white-space: nowrap;">
    <li>Response.TrySkipIisCustomErrors = <span css="color: #0000ff;">true</span>;</li>
</ol>
</div>
</div>
</div>
...
<div className="wlWriterEditableSmartContent" id="scid:9ce6104f-a9aa-4a17-a79f-3a39532ebf7c:931bb6ce-8973-4f42-ad01-3e7baba5c17f" css="margin: 0px; display: inline; float: none; padding: 0px;">
<div css="border: #000080 1px solid; color: #000; font-family: 'Courier New', Courier, Monospace; font-size: 10pt;">
<div css="background: #ddd; max-height: 300px; overflow: auto;">
<ol css="background: #ffffff; margin: 0 0 0 2em; padding: 0 0 0 5px; white-space: nowrap;">
    <li><span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">system.webServer</span><span css="color: #0000ff;">&gt;</span></li>
    <li css="background: #f3f3f3;">    <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">httpErrors</span><span css="color: #ff0000;">errorMode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">Custom</span>"<span css="color: #0000ff;"> &gt;</span></li>
    <li>        <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">remove</span><span css="color: #ff0000;">statusCode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">404</span>"<span css="color: #ff0000;">subStatusCode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">-1</span>"<span css="color: #0000ff;">/&gt;</span></li>
    <li css="background: #f3f3f3;">        <span css="color: #0000ff;">&lt;</span><span css="color: #a31515;">error</span><span css="color: #ff0000;">statusCode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">404</span>"<span css="color: #ff0000;">path</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">/404</span>"<span css="color: #ff0000;">responseMode</span><span css="color: #0000ff;">=</span>"<span css="color: #0000ff;">ExecuteURL</span>"<span css="color: #0000ff;"> /&gt;</span></li>
    <li>    <span css="color: #0000ff;">&lt;/</span><span css="color: #a31515;">httpErrors</span><span css="color: #0000ff;">&gt;</span></li>
    <li css="background: #f3f3f3;"><span css="color: #0000ff;">&lt;/</span><span css="color: #a31515;">system.webServer</span><span css="color: #0000ff;">&gt;</span></li>
</ol>
</div>
</div>
</div>
