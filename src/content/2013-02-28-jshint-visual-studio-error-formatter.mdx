...
excerpt: How to get JSHint to output Visual Studio aware error messages.
date: 2013-02-28
---
...
![Error Message Explanation](/img/posts/JSHintErrorMessage.png)
